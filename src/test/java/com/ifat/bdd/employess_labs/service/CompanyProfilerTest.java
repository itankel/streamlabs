    ...
    public void createEmployees() {
        listOfEmployees = List
                .of(Employee.builder().firstName("DANNY").lastName("Harel").salary(20000).gender(Gender.MAN)
                                ...
                                .employeeCategory(EmployeeCategory.getEmployeeCategory(20000)).build(),
                        Employee.builder().firstName("Daniela").lastName("Harel").salary(13000).gender(Gender.WOMAN)
                                .companyName("CompanyA")
                                .employeeCategory(EmployeeCategory.getEmployeeCategory(13000)).build(),
                        Employee.builder().firstName("Ran").lastName("Barel").salary(15000).gender(Gender.MAN)
                                .companyName("CompanyA")
                                .employeeCategory(EmployeeCategory.getEmployeeCategory(15000)).build(),
                        Employee.builder().firstName("RINA").lastName("Barel").salary(35000).gender(Gender.WOMAN)
                                .companyName("CompanyB")
                                .employeeCategory(EmployeeCategory.getEmployeeCategory(35000)).build(),
                        ...
                        Employee.builder().firstName("Limor").lastName("Evyatar").salary(22000).gender(Gender.MAN)
                                .companyName("CompanyB")
                                .employeeCategory(EmployeeCategory.getEmployeeCategory(22000)).build(),
                        Employee.builder().firstName("Tom").lastName("Levi").salary(13500).gender(Gender.WOMAN)
                                .companyName("CompanyA")
                                .employeeCategory(EmployeeCategory.getEmployeeCategory(13500)).build(),
                        Employee.builder().firstName("Tamar").lastName("Luria").salary(12500).gender(Gender.WOMAN)
                                .companyName("CompanyA")
                                .employeeCategory(EmployeeCategory.getEmployeeCategory(12500)).build());
    }

    @Test
    @Ignore // still need to make it work
    public void TestCategorize() {
        CompanyProfiler.categorize(this.listOfEmployees);
    }
